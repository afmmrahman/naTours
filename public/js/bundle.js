...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGFyZXFyYWhtYW4iLCJhIjoiY2szOWIzbzR4MDBxZjNtcXRjb21mcm5tNyJ9.yk-PWNICsP_EhhOU3Q1unw';
...
var showAlert = function showAlert(type, msz) {
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msz, "</div>");
...
/* eslint-disable */
var stripe = Stripe('pk_test_pdnXOCLV9JN2fQVgNEAr88OL00jijFCmnJ');
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return regeneratorRuntime.awrap((0, _axios.default)("http://127.0.0.1:3000/api/v1/bookings/checkout-sessions/".concat(tourId)));

        case 3:
          session = _context.sent;
          console.log(session); // 2) Create check out form + charge credit card
...
var logingForm = document.querySelector('.form--login');
